package co.uk.gokul.letscook.feature.mealdetails.data.mapper
...
import co.uk.gokul.letscook.feature.mealdetails.domain.model.Meal
import co.uk.gokul.letscook.feature.mealdetails.domain.model.MealDetails

/**
 * Maps [MealDetailsResponse] DTO to [MealDetails] domain model.
 *
 * @param category Optional category to populate in domain models.
 * @param area Optional area to populate in domain models.
 */
fun MealDetailsResponse.toDomain(category: String? = null, area: String? = null) = MealDetails(
    meals = this.meals.map { it.toDomain(category, area) }
)
...
fun MealDto.toDomain(category: String? = null, area: String? = null) = Meal(
    ...
    strMealThumb = this.strMealThumb.plus("/medium"),
 ...
 *
 * This conversion is used when serving detailed meal data from the local cache.
 */
